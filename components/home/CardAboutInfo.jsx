...
const CardAboutInfo = () => {
  return (
    <div className="w-full max-w-7xl mx-auto flex flex-col items-center gap-6 mt-13 ">
      ...
      <div className="w-full bg-[#A3EFFF] border-2 border-gray-600 rounded-xl flex flex-col md:flex-row justify-between overflow-hidden p-5 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
