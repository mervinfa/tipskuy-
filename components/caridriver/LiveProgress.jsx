...
import PopUpCancel from "@/components/caridriver/PopUpCancel";
    ...
    <div className="w-full max-w-5xl mx-auto bg-[#FFB041] border-[4px] border-black rounded-xl p-6 md:p-8 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sticky top-32 z-[80] mb-4 mt-12 animate-in fade-in slide-in-from-top-4 duration-500 hover:bg-yellow-100">
      ...
      <div className="mt-8 flex justify-end md:absolute md:top-6 md:right-6 md:mt-0">
        <button 
          ...
          className="bg-red-500 hover:bg-red-600 text-white font-extrabold text-sm md:text-base py-2 px-4 md:px-6 border-[3px] border-black rounded-lg shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none transition-all"
        >
          Driver Batal (Test)
        </button>
        ...
        <PopUpCancel isOpen={isCancelOpen} onClose={() => setIsCancelOpen(false)} />
