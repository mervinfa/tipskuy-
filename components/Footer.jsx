...
const Footer = () => {
  return (
    <footer className="bg-[#E5E5E5] py-10 md:py-16 px-6 md:px-12 w-full">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-10 md:gap-4">
        <div className="flex flex-col gap-4 items-center justify-center">
          <h1 className="font-extrabold text-4xl md:text-5xl text-black tracking-wide">
            TipSkuy!
          </h1>
        ...
        <div className="flex flex-col gap-2 text-gray-600 text-lg md:text-xl font-medium">
          <p>TipSkuyOfficial@gmail.com</p>
          <p>0896-3042-7670</p>
        </div>

        <div className="flex flex-col gap-3 text-base md:text-lg font-bold">
